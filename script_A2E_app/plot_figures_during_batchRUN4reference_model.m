...
addpath(strcat(codeFolder,filesep,"othercolor",filesep,"othercolor"))
...
%%    
figure('Renderer', 'painters', 'Position', [50 50 600 550])
subplot(2,2,1)
hold on

for i=2:2
    errorbar(Age(system==i),Elevation(system==i),Error(system==i),age_symboles{i},'horizontal','CapSize',0,'MarkerEdgeColor','black','Color','black');
    plot(age_po(system==i),Elevation(system==i),age_symboles{i},'MarkerEdgeColor','blue');
end
box on
...
text(22, .87, {text2print2;text2print4},'fontsize', 8);
